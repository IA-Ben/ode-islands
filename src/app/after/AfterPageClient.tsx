      ...
      case 'message':
        return (
          ...
          >
            ...
            <div className={`${surfaces.subtleGlass} rounded-xl p-6 border border-slate-700/50 text-center`}>
              ...
              <div className="w-full bg-white/20 rounded-full h-2 mb-4">
                <div className={`${colors.gradients.primary} h-2 rounded-full w-3/4 transition-all duration-1000`}></div>
              </div>
      ...
      case 'fan-score':
        return (
          <div className="space-y-8">
            ...
            >
              <div className={`${surfaces.cardGlass} rounded-2xl border border-slate-700/50 p-6`}>
        ...
        return (
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div 
                className={`${surfaces.cardGlass} rounded-xl border border-slate-700/50 p-8 text-center transform transition-all duration-300 hover:scale-105`}
                style={{
                  opacity: 0,
            ...
            <div className="text-center">
              <div className={`${surfaces.subtleGlass} rounded-xl border border-slate-700/50 p-6 max-w-md mx-auto`}>
        ...
        return (
          <div className="space-y-12">
            ...
            >
              ...
              >
                <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-fuchsia-500/30 transition-colors">
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
                  </svg>
                </div>
                <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-fuchsia-200 transition-colors">
                  Memory Wallet
                </h3>
                <p className="text-white/70 leading-relaxed">
              ...
              <div 
                className={`${surfaces.cardGlass} rounded-2xl border border-slate-700/50 p-8 text-center transform transition-all duration-300 hover:scale-105 hover:bg-slate-800/60`}
                style={{
                  opacity: 0,
  ...
  return (
    <>
      ...
      {activeTab !== 'overview' ? (
          ...
          headerContent={
            <div className="flex items-center justify-between w-full">
              ...
              <button
                ...
                className={`group flex items-center space-x-2 text-white/90 hover:text-white transition-all duration-200 text-sm font-medium ${surfaces.subtleGlass} px-4 py-2 rounded-lg border border-slate-700/50 hover:bg-white/15`}
              >
        ...
        >
          <div 
            className={`${surfaces.subtleGlass} rounded-lg border border-slate-700/50 p-1 mb-8`}
            style={{
              opacity: 0,
