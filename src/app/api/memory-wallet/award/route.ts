...
async function handlePOST(request: NextRequest) {
  try {
    ...
    const memoryData = {
      ...
      mediaUrl: memoryTemplate.mediaAsset, // Use mediaAsset from schema
      mediaType: memoryTemplate.mediaType as 'image' | 'video' | 'audio' | 'text' | null,
      thumbnail: memoryTemplate.mediaAsset, // Use mediaAsset as thumbnail fallback
      ...
      memoryCategory: null, // Not in template schema
      emotionalTone: null, // Not in template schema
      autoGenerated: true,
      isFavorite: false,
